  ...
  grunt.initConfig({
    ...
    concat: {
      dist: {
          ...
          dest: '<%= yeoman.dist %>/scripts/cids-custom-rest-js.js'
      }
    },
    rev: {
      dist: {
    ...
    replace: {
        ...
        debugCode: {
            ...
            src: ['.tmp/concat/scripts/cids-custom-rest-js.min.js'],
            dest: ['.tmp/concat/scripts/cids-custom-rest-js.min.js'],
            replacements: [
    ...
    uglify: {
        my_target: {
            files: {
                'dist/scripts/cids-custom-rest-js.min.js': ['<%= yeoman.dist %>/scripts/*.js']
            }
        }
    },
    echoMessage: {
